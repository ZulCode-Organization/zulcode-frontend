 ...
 *
 * Cada capa tem duas artes: a larga so cabe inteira no computador, e no
 * celular, onde a capa fica quase tres vezes mais estreita, ela apareceria
 * cortada demais. Faltando a do celular, a larga vale em todas as larguras.
 */
const ARTE = {
  richard: { desktop: "/banner/banner-richard.png", mobile: "/banner/banner-richard-mobile.png" },
  pioneiro: { desktop: "/banner/banner-pioneiro.png", mobile: "/banner/banner-pioneiro-mobile.png" },
  dev: { desktop: "/banner/banner-desenvolvedor.png", mobile: "/banner/banner-desenvolvedor-mobile.png" },
  pro: { desktop: "/banner/banner-pro.png", mobile: "/banner/banner-pro-mobile.png" },
};
